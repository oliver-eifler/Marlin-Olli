...
#define STRING_CONFIG_H_AUTHOR "(Olli, a20m config)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // A20M [@olli]
  #define DEFAULT_bedKp 114.19
  #define DEFAULT_bedKi 20.20
  #define DEFAULT_bedKd 430.31
...
// junction_deviation_mm = 0.4 * (jerk*jerk)/acceleration
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37.0, 0, -3.4 }
...
#define INVERT_E0_DIR true //bondtech bmg clone
#define INVERT_E1_DIR true //bondtech bmg clone
