...
#define STRING_CONFIG_H_AUTHOR "(Olli, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Olli E3"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Olli Ender 3
  #define DEFAULT_bedKp 268.88
  #define DEFAULT_bedKi 50.49
  #define DEFAULT_bedKd 357.94
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET ((235-170)/2)    // (mm) An inset for corner leveling
