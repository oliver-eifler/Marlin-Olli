...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  5, 5 }, { 205,  5 }, { 205, 205 }, { 5, 205 } }
...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_5X_STEPS_PER_SEC   10  // (steps/s) Encoder rate for 5x speed
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LCD_INFO_MENU
    ...
    #define LCD_INFO_BUILDTIME // //Olli: Show build time
      ...
      #else
        // string helpers for buildtimestamp
